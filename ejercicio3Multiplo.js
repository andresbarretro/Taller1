...
let numero = Number(prompt("Quieres saber si tu numero es multiplo de 5, ingresado aca:"))

// con el operador % (modulo) verifico si el residuo de la division del numero ingresado por 5 es igual a 0
